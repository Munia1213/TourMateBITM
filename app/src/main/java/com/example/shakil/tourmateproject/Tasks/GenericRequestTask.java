package com.example.shakil.tourmateproject.Tasks;
...
import com.example.shakil.tourmateproject.Common.Constants;
...
public abstract class GenericRequestTask extends AsyncTask<String, String, TaskOutput> {
    ...
    public GenericRequestTask(Context context, WeatherInfo activity, ProgressDialog progressDialog) {
