...
import com.example.shakil.tourmateproject.BuildConfig;
import com.example.shakil.tourmateproject.Common.AlarmReceiver;
...
public class TimeWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "com.example.shakil.tourmateproject.martykan.forecastie.UPDATE_TIME";
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int widgetId : appWidgetIds) {
            ...
            Intent intent2 = new Intent(context, WeatherInfo.class);
