...
import com.example.shakil.tourmateproject.Adapter.ViewPagerAdapter;
import com.example.shakil.tourmateproject.Adapter.WeatherRecyclerAdapter;
import com.example.shakil.tourmateproject.Fragment.RecyclerViewFragment;
import com.example.shakil.tourmateproject.Model.Weather;
import com.example.shakil.tourmateproject.Tasks.GenericRequestTask;
import com.example.shakil.tourmateproject.Tasks.ParseResult;
import com.example.shakil.tourmateproject.Tasks.TaskOutput;
import com.example.shakil.tourmateproject.Utils.UnitConvertor;
import com.example.shakil.tourmateproject.Widget.AbstractWidgetProvider;
import com.example.shakil.tourmateproject.Widget.DashClockWeatherExtension;
...
public class WeatherInfo extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(WeatherInfo.this);
    ...
    protected void onDestroy() {
        ...
        if (locationManager != null) {
            try {
                locationManager.removeUpdates(WeatherInfo.this);
    ...
    private void preloadWeather() {
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(WeatherInfo.this);
    ...
    private void saveLocation(String result) {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(WeatherInfo.this);
    ...
    class TodayWeatherTask extends GenericRequestTask {
        ...
        public TodayWeatherTask(Context context, WeatherInfo activity, ProgressDialog progressDialog) {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(WeatherInfo.this);
            DashClockWeatherExtension.updateDashClock(WeatherInfo.this);
        }
    ...
    class LongTermWeatherTask extends GenericRequestTask {
        public LongTermWeatherTask(Context context, WeatherInfo activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
    ...
    class ProvideCityNameTask extends GenericRequestTask {
        ...
        public ProvideCityNameTask(Context context, WeatherInfo activity, ProgressDialog progressDialog) {
            super(context, activity, progressDialog);
        }
