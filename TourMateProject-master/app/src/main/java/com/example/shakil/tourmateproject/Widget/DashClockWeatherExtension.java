...
public class DashClockWeatherExtension extends DashClockExtension {
    ...
    private static final Uri URI_BASE = Uri.parse("content://com.example.shakil.tourmateproject.martykan.forecastie.authority");
    ...
    private String localize(SharedPreferences sp, String preferenceKey, String defaultValueKey) {
        return WeatherInfo.localize(sp, this, preferenceKey, defaultValueKey);
    }
